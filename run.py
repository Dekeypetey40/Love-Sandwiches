...
def get_sales_data():
    ...
    by commas. The loop will run until the data is valid.
    """
    while True:
...
def update_worksheet(data, worksheet):
    """
    Receives list of integers to insert into a worksheet.
...
def calculate_surplus_data(sales_row):
    ...
    -Negative surplus indicates extras were made when stock ran out
    """
...
#The -5: below allows me to take 5 from the column starting at the bottom
        columns.append(column[-5:])
    return columns
        
def calculate_stock_data(data):
    """
    Calculate the average stock for each sandwich, adding 10%
    """
